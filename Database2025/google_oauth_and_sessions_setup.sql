-- =============================================
-- Google OAuth Login and Session Management Setup
-- =============================================

-- Check and add Google OAuth columns to existing Users table if they don't exist
...
IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('NewsSitePro2025_Users') AND name = 'IsGoogleUser')
    ALTER TABLE NewsSitePro2025_Users ADD IsGoogleUser BIT DEFAULT 0;
...
-- Create unique index for Google ID if it doesn't exist
...
-- =============================================
-- User Sessions Table for tracking login/logout times and session expiration
-- =============================================
...
BEGIN
    CREATE TABLE NewsSitePro2025_UserSessions (
        ...
        LogoutReason NVARCHAR(100) NULL, -- 'Manual', 'Expired', 'Forced', 'NewSession'
...
-- =============================================
-- OAuth Access Tokens Table (for storing Google tokens)
-- =============================================
...
-- Create indexes for OAuth tokens if they don't exist
...
-- =============================================
-- Stored Procedures for Google OAuth Operations
-- =============================================
...
-- Update existing procedures to include Google OAuth support
-- (You may need to modify existing login procedures to check for Google users)
...
-- =============================================
-- Initial data cleanup and setup
-- =============================================
GO
-- Clean up any expired sessions on script run
EXEC NewsSitePro2025_sp_UserSessions_Cleanup;

PRINT 'Google OAuth and Session Management setup completed successfully!';
PRINT 'Tables created: NewsSitePro2025_UserSessions, NewsSitePro2025_OAuthTokens';
